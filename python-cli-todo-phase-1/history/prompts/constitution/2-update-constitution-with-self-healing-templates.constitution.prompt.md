---
id: 2
title: Update constitution with self-healing templates
stage: constitution
date: 2025-12-07
surface: agent
...
branch: unknown
user: user
command: /sp.constitution update Hackathon II — Spec-Driven Todo Application
labels: ["constitution", "update", "self-healing"]
links:
  spec: null
  ticket: null
  adr: null
...
/sp.constitution update Hackathon II — Spec-Driven Todo Application
